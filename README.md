...
Expected 0.3.3 application outputs:
...
InnAware-PMS-Emulator-Windows-0.3.3.zip
InnAware-PMS-Emulator-Source-0.3.3.zip
...
The 0.3.3 development line corrects protocol-pack update-state comparison while retaining the Mitel 1/2 and update infrastructure introduced in 0.3.1. It remains a field-beta prerelease.
