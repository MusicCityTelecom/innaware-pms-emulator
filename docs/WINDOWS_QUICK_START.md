...
1. Download `InnAware-PMS-Emulator-Windows-0.4.2.zip` from the current release.
...
With prerelease updates enabled, a successful update check for 0.4.2 should report:
