...
from innaware_pms_emulator.threecx_mitel_diagnostics import (
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Characterize the source-backed 3CX Hotel Module Mitel-SX2000 "
            "PMS-to-PBX transaction surface without inferring a site port, reverse direction, or compatibility promotion."
        )
    )
    parser.add_argument(
        "capture",
