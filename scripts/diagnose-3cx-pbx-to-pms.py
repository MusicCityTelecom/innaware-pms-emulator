...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Characterize source-documented 3CX Hotel Module Mitel-SX2000 PBX-to-PMS MSG/STS "
            "records without inferring a reverse handshake, site port, field layout, or compatibility row."
        )
    )
    parser.add_argument(
        "capture",
