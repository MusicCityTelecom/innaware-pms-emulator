...
PERSONALITIES: dict[str, EndpointPersonality] = {
    ...
    "pbx-phonesuite": EndpointPersonality(
        ...
        description="PhoneSuite hospitality PBX personality. Mitel-family application compatibility is available as an explicitly selected wire/profile choice, but PhoneSuite-specific serial settings remain evidence-qualified rather than inherited from Mitel defaults.",
        ...
        notes=(
            ...
            "No serial profile is auto-recommended for PhoneSuite because current PhoneSuite evidence does not qualify baud, data bits, parity, stop bits, or flow-control defaults; enter the site's serial settings explicitly.",
            "Selecting a generic Mitel profile is an operator choice and must not be interpreted as evidence that Mitel serial defaults are PhoneSuite defaults.",
        ),
        compatibility_family="mitel_hospitality",
        brand="PhoneSuite",
    ),
